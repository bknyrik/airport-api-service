...
FLIGHT_RETRIEVE_RESPONSES = {
    status.HTTP_200_OK: GOT_FLIGHT_INFO,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_403_FORBIDDEN: user_responses.USER_IS_NOT_ADMIN,
...
FLIGHT_CREATE_RESPONSES = {
    status.HTTP_201_CREATED: GOT_DETAILED_FLIGHT_INFO,
    status.HTTP_400_BAD_REQUEST: FLIGHT_INVALID_DATA,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_403_FORBIDDEN: user_responses.USER_IS_NOT_ADMIN,
    status.HTTP_429_TOO_MANY_REQUESTS: user_responses.USER_REACHED_LIMIT_REQUESTS
}

FLIGHT_UPDATE_RESPONSES = {
    status.HTTP_200_OK: GOT_DETAILED_FLIGHT_INFO,
    status.HTTP_400_BAD_REQUEST: FLIGHT_INVALID_DATA,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_403_FORBIDDEN: user_responses.USER_IS_NOT_ADMIN,
    status.HTTP_404_NOT_FOUND: FLIGHT_NOT_FOUND,
...
FLIGHT_PARTIAL_UPDATE_RESPONSES = FLIGHT_UPDATE_RESPONSES

FLIGHT_DESTROY_RESPONSES = {
    status.HTTP_204_NO_CONTENT: None,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_403_FORBIDDEN: user_responses.USER_IS_NOT_ADMIN,
    status.HTTP_404_NOT_FOUND: FLIGHT_NOT_FOUND,
...
ORDER_CREATE_RESPONSES = {
    status.HTTP_201_CREATED: GOT_DETAILED_ORDER_INFO,
    status.HTTP_400_BAD_REQUEST: ORDER_INVALID_DATA,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_429_TOO_MANY_REQUESTS: user_responses.USER_REACHED_LIMIT_REQUESTS
}

ORDER_RETRIEVE_RESPONSES = {
    status.HTTP_200_OK: GOT_ORDER_INFO,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_404_NOT_FOUND: ORDER_NOT_FOUND,
    status.HTTP_429_TOO_MANY_REQUESTS: user_responses.USER_REACHED_LIMIT_REQUESTS
}

ORDER_UPDATE_RESPONSES = {
    status.HTTP_200_OK: GOT_DETAILED_ORDER_INFO,
    status.HTTP_400_BAD_REQUEST: ORDER_INVALID_DATA,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_404_NOT_FOUND: ORDER_NOT_FOUND,
    status.HTTP_429_TOO_MANY_REQUESTS: user_responses.USER_REACHED_LIMIT_REQUESTS
...
ORDER_PARTIAL_UPDATE_RESPONSES = ORDER_UPDATE_RESPONSES

ORDER_DESTROY_RESPONSES = {
    status.HTTP_204_NO_CONTENT: None,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_404_NOT_FOUND: ORDER_NOT_FOUND,
    status.HTTP_429_TOO_MANY_REQUESTS: user_responses.USER_REACHED_LIMIT_REQUESTS
...
ROUTE_LIST_INVALID_PARAMETERS = OpenApiResponse(
    ...
    response=OpenApiTypes.OBJECT,
    examples=[
        examples.SOURCE_ID_INVALID_CHOICE,
...
ROUTE_CREATE_RESPONSES = {
    status.HTTP_201_CREATED: GOT_DETAILED_ROUTE_INFO,
    status.HTTP_400_BAD_REQUEST: ROUTE_INVALID_DATA,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_403_FORBIDDEN: user_responses.USER_IS_NOT_ADMIN,
    status.HTTP_429_TOO_MANY_REQUESTS: user_responses.USER_REACHED_LIMIT_REQUESTS
}

ROUTE_RETRIEVE_RESPONSES = {
    status.HTTP_200_OK: GOT_ROUTE_INFO,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_403_FORBIDDEN: user_responses.USER_IS_NOT_ADMIN,
...
ROUTE_PARTIAL_UPDATE_RESPONSES = ROUTE_UPDATE_RESPONSES

ROUTE_DESTROY_RESPONSES = {
    status.HTTP_204_NO_CONTENT: None,
    status.HTTP_401_UNAUTHORIZED: user_responses.USER_IS_UNAUTHORIZED,
    status.HTTP_403_FORBIDDEN: user_responses.USER_IS_NOT_ADMIN,
    status.HTTP_404_NOT_FOUND: ROUTE_NOT_FOUND,
