...
class FacilityViewSet(ModelViewSet):
    ...
    @extend_schema(
        description="Returns information about facility by its identifier.",
        summary="Get the facility by id",
        responses=responses.FACILITY_RETRIEVE_RESPONSES
    )
...
class AirportViewSet(ModelViewSet):
    ...
    @extend_schema(
        description=(
            "Takes a file that represents an image and returns information"
            " about image assigned to airport by its identifier."
        ),
        summary="Upload an image to the airport by id",
        responses=responses.AIRPORT_UPLOAD_IMAGE_RESPONSES
    )
    @action(
        methods=("POST",),
        detail=True,
...
class CrewViewSet(ModelViewSet):
    ...
    @extend_schema(
        summary="Get the crew by id",
        description="Returns information about crewmember by its identifier.",
        responses=responses.CREW_RETRIEVE_RESPONSES
    )
    def retrieve(self, request: Request, *args, **kwargs) -> Response:
        return super().retrieve(request, *args, **kwargs)
...
class RouteViewSet(ModelViewSet):
    ...
    @extend_schema(
        description=(
            "Takes data and returns information about updated route "
            "by its identifier."
        ),
        summary="Completely update route by id",
        responses=responses.ROUTE_UPDATE_RESPONSES
    )
    def update(self, request: Request, *args, **kwargs) -> Response:
        return super().update(request, *args, **kwargs)
